...
def api_start():
    ...
    try:
        ...
        params = dict(
            ...
            water_temp_enabled=bool(data.get("water_temp_enabled", False)),
            battery_enabled=bool(data.get("battery_enabled", False)),
            air_temp_enabled=bool(data.get("air_temp_enabled", False)),
            tanks_enabled=bool(data.get("tanks_enabled", False)),
            ...
            depth_offset_m=float(data.get("depth_offset_m", 0.3)),
            water_temp_c=float(data.get("water_temp_c", 18.0)),
            battery_v=float(data.get("battery_v", 12.7)),
            air_temp_c=float(data.get("air_temp_c", 23.0)),
            tank_fresh_water=float(data.get("tank_fresh_water", 75.0)),
